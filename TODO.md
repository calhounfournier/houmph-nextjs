...
### Configuration
- [x] Changed recipient email to cafournier@me.com
...
5. **If Using Sandbox** (5 minutes)
   - Authorize cafournier@me.com in Mailgun
...
- Sends 2 emails per form submission:
  1. Notification to recipient (cafournier@me.com)
...
EMAIL_RECIPIENTS=cafournier@me.com      # Optional (has default)
```
...
4. Changed recipient email to cafournier@me.com
